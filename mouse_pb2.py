...
_EVENTDETAILS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='on_hold', full_name='mouseSenderPackage.EventDetails.on_hold', index=7,
...
_KEYSTROKE = _descriptor.Descriptor(
  name='KeyStroke',
  full_name='mouseSenderPackage.KeyStroke',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='mouseSenderPackage.KeyStroke.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='on_hold', full_name='mouseSenderPackage.KeyStroke.on_hold', index=1,
...
KeyStroke = _reflection.GeneratedProtocolMessageType('KeyStroke', (_message.Message,), {
  ...
  '__module__' : 'mouse_pb2'
  # @@protoc_insertion_point(class_scope:mouseSenderPackage.KeyStroke)
  })
